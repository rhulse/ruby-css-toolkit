...
This project is for optimizing and compressing CSS files.

NB: Currently the tidy section is a work-in-progress
...
It will group selectors with identical rulesets, so you cannot turn this feature on
...
Theis CSS Tidy has the following features:

*(NB: Some of these are still planned features)*
